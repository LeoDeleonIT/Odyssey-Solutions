...
3. If both pages compete for the same queries, make the broad support page the primary URL, move any unique identity guidance into it, and permanently redirect the narrower page.
4. Update resource-hub and article links to point to the selected primary page.
